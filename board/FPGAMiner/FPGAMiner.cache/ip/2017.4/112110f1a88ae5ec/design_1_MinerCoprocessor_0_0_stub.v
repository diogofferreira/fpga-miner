...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(readEnable, validData, allWordsSent, 
  counterSlave, counterMaster, hashOut, tempHash, nonce, mEnable, update, m00_axis_tdata, 
...
/* synthesis syn_black_box black_box_pad_pin="readEnable,validData,allWordsSent,counterSlave[3:0],counterMaster[3:0],hashOut[255:0],tempHash[255:0],nonce[31:0],mEnable,update,m00_axis_tdata[31:0],m00_axis_tstrb[3:0],m00_axis_tlast,m00_axis_tvalid,m00_axis_tready,m00_axis_aclk,m00_axis_aresetn,s00_axis_tdata[31:0],s00_axis_tstrb[3:0],s00_axis_tlast,s00_axis_tvalid,s00_axis_tready,s00_axis_aclk,s00_axis_aresetn" */;
  output readEnable;
  output validData;
  output allWordsSent;
