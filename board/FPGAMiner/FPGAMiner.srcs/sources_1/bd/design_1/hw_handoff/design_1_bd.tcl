...
proc create_root_design { parentCell } {
  ...
  # Create instance: MinerCoprocessor_0, and set properties
  set MinerCoprocessor_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:MinerCoprocessor:1.0 MinerCoprocessor_0 ]
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net MinerCoprocessor_0_M00_AXIS [get_bd_intf_pins MinerCoprocessor_0/M00_AXIS] [get_bd_intf_pins microblaze_0/S0_AXIS]
  ...
  connect_bd_intf_net -intf_net microblaze_0_M0_AXIS [get_bd_intf_pins MinerCoprocessor_0/S00_AXIS] [get_bd_intf_pins microblaze_0/M0_AXIS]
  ...
  connect_bd_net -net fit_timer_0_Interrupt [get_bd_pins fit_timer_0/Interrupt] [get_bd_pins microblaze_0_xlconcat/In2]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins rst_clk_wiz_1_100M/mb_debug_sys_rst]
  connect_bd_net -net microblaze_0_Clk [get_bd_pins DisplayController_0/s00_axi_aclk] [get_bd_pins MinerCoprocessor_0/m00_axis_aclk] [get_bd_pins MinerCoprocessor_0/s00_axis_aclk] [get_bd_pins axi_emc_0/rdclk] [get_bd_pins axi_emc_0/s_axi_aclk] [get_bd_pins axi_ethernetlite_0/s_axi_aclk] [get_bd_pins axi_gpio_led/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins fit_timer_0/Clk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A00000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs DisplayController_0/S00_AXI/S00_AXI_reg] SEG_DisplayController_0_S00_AXI_reg
