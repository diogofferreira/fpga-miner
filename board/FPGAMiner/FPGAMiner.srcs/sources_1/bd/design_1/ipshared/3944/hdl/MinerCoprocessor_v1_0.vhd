...
entity MinerCoprocessor_v1_0 is
	...
	port (
        ...
        hashOut : out std_logic_vector(HASH_LENGTH-1 downto 0);
        tempHash : out std_logic_vector(HASH_LENGTH-1 downto 0);
...
architecture arch_imp of MinerCoprocessor_v1_0 is
    ...
    signal s_nonce        : std_logic_vector(C_M00_AXIS_TDATA_WIDTH-1 downto 0);
